import { decompressPublicKey, prepend0x, strip0x } from ".";
...
describe("strip0x", () => {
  it("strips 0x if present", () => {
    expect(strip0x("3659387299A766930CbF9948899690CC5336202A")).toBe(
      "3659387299A766930CbF9948899690CC5336202A"
    );
    expect(strip0x("0x3659387299A766930CbF9948899690CC5336202A")).toBe(
      "3659387299A766930CbF9948899690CC5336202A"
    );
    expect(strip0x("0X3659387299A766930CbF9948899690CC5336202A")).toBe(
      "3659387299A766930CbF9948899690CC5336202A"
...
describe("prepend0x", () => {
  it("adds 0x if not already present", () => {
    expect(prepend0x("3659387299A766930CbF9948899690CC5336202A")).toBe(
      "0x3659387299A766930CbF9948899690CC5336202A"
    );
    expect(prepend0x("0x3659387299A766930CbF9948899690CC5336202A")).toBe(
      "0x3659387299A766930CbF9948899690CC5336202A"
    );
    expect(prepend0x("0X3659387299A766930CbF9948899690CC5336202A")).toBe(
      "0x3659387299A766930CbF9948899690CC5336202A"
